...
// const parseRequestParametersIntoMongoDBQuery = (requestParameters: any, entityFields: string[]) => {
//     try {
...
// const _checkAllParameter = (requestParameters: any) => {
//     return (true === requestParameters.all) ? {} : null;
// };

// const _checkFilterByParameter = (requestParameters: any, entityFields: string[]) => {
